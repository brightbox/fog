...
require 'builder'
require 'brightbox-fog/vcloud/model'
require 'brightbox-fog/vcloud/collection'
require 'brightbox-fog/vcloud/generators'
...
module Fog
  class Vcloud < Fog::Service
    ...
    model_path 'brightbox-fog/vcloud/models'
    model :vdc
    collection :vdcs

    request_path 'brightbox-fog/vcloud/requests'
    request :login
...
require 'brightbox-fog/vcloud/terremark/ecloud'
require 'brightbox-fog/vcloud/terremark/vcloud'
